    ...
    <div className={styles.container || ''} style={{ display: 'flex', flexDirection: 'column', height: '100vh', backgroundColor: '#f8fafc', color: '#1e293b' }}>
      ...
      <style>{`
        @media (max-width: 768px) {
          .admin-main { flex-direction: column !important; }
          .admin-nav {
            width: 100% !important;
          ...
          .admin-nav p, .admin-nav div.org-id {
      ...
      <main className="admin-main" style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        {/* Sidebar */}
        <nav className="admin-nav" style={{ width: '250px', flexShrink: 0, backgroundColor: '#ffffff', borderRight: '1px solid #e2e8f0', padding: '1.75rem 1rem', overflowY: 'auto' }}>
          ...
          <div className="org-id" style={{ padding: '0 0.85rem', marginBottom: '1.5rem', fontSize: '0.7rem', color: '#94a3b8' }}>
        ...
        {/* Content Area */}
        <div className="admin-content" style={{ flex: 1, overflowY: 'auto', padding: '2.5rem 3.5rem', backgroundColor: '#f8fafc', position: 'relative' }}>
